...
public class Sar extends AbstractProcessor {
  ...
  private static /*@Regex(5)*/ String regex = "([0-9]{4}-[0-9]{2}-[0-9]{2} [0-9]{2}:[0-9]{2}:[0-9]{2},[0-9]{3}) (.*?) (.*?): (.*?) \\((.*?)\\)";
  private static /*@Regex(5)*/ Pattern p = null;

  private /*@Regex(5)*/ Matcher matcher = null;
