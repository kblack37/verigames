...
/**
	 ...
	 * @author Rich
	 */
class NumberlineSubtractAnimator implements IFractionAnimator
{
    ...
    {
        return CgsFVConstants.NUMBERLINE_STANDARD_SUBTRACT;
    }
...
//        var midpointY : Float = -resultModule.unitHeight / 2 - (NumberlineConstants.TICK_EXTENSION_DISTANCE * 2) - (NumberRenderer.MAX_BOX_HEIGHT * (3 / 2)) - secondModule.unitHeight -NumberlineConstants.TICK_EXTENSION_DISTANCE - NumberlineConstants.ANIMATION_MARGIN_VERTICAL_SMALL  /*- (NumberRenderer.MAX_BOX_HEIGHT / 2)*/  ;
//        var midpointToFractionDist : Float = NumberlineConstants.ANIMATION_MARGIN_VERTICAL_SMALL + NumberlineConstants.TICK_EXTENSION_DISTANCE + firstModule.unitHeight  /*+ (NumberRenderer.MAX_BOX_HEIGHT / 2)*/  ;
...
//        var doShowAlignment : Bool = origFirstFraction.value != origSecondFraction.value;
//        var secondAlignedX : Float = newSecondPosition.x + firstModule.valueWidth - secondModule.valueWidth;
...
//        var secondAlignLine_endY : Float = midpointToFractionDist + secondModule.getValueNRPosition(false, origSecondFraction.denominator == 1).y - NumberRenderer.MAX_BOX_HEIGHT / 2;
...
//        secondAlignLine.x = newSecondPosition.x + secondModule.valueOffsetX;
...
//
//        // Tween into position
//        var position_unitDelay : Float = m_animHelper.computeScaledTime(NumberlineConstants.TIME_SUB_DELAY_AFTER_POSITION);
//        var position_unitDuration : Float = m_animHelper.computeScaledTime(NumberlineConstants.TIME_SUB_DURATION_POSITION);
...
//        if (doShowAlignment)
//        {
//            var align_unitDelay : Float = m_animHelper.computeScaledTime(NumberlineConstants.TIME_SUB_DELAY_AFTER_ALIGN);
//            var align_unitDuration : Float = m_animHelper.computeScaledTime(NumberlineConstants.TIME_SUB_DURATION_ALIGN);
...
//            var showSecondLineStartTime : Float = showFirstLinePhaseTwoStart + align_unitDuration;
//            var showSecondLinePhaseTwoStart : Float = showSecondLineStartTime + align_unitDuration;
//            var showSecondLinePhaseTwoCallback : Float = showSecondLinePhaseTwoStart + align_unitDuration;
//            var moveLineStartTime : Float = showSecondLinePhaseTwoCallback + .1;
...
//                    }));
//
//            // Emphasize second's value, for alignment
//            alignStep.addTweenSet(showSecondLineStartTime, FVEmphasis.computePulseTweens(secondSegment, align_unitDuration, 1, 1, NumberlineConstants.PULSE_SCALE_SEGMENT));
//
//            // Show second alignment line
//            alignStep.addTween(showSecondLinePhaseTwoStart, new GTween(secondAlignLineMask, align_unitDuration, {
...
//                        ease : Sine.easeInOut
//                    }));
//            alignStep.addTween(moveLineStartTime, new GTween(secondSegmentHolder, align_unitDuration, {
//                        x : secondAlignedX
//                    }, {
//                        ease : Sine.easeInOut
//                    }));
...
//
//        // Tween drop
//        var drop_unitDelay : Float = m_animHelper.computeScaledTime(NumberlineConstants.TIME_SUB_DELAY_AFTER_DROP);
//        var drop_unitDuration : Float = m_animHelper.computeScaledTime(NumberlineConstants.TIME_SUB_DURATION_DROP);
...
//        var drop_dropLine_startTime : Float = drop_showResult_startTime + drop_unitDuration;
...
//        /*if (doSimplify)
//			{
//				var simplificationStep:AnimationStep = new AnimationStep(GenConstants.STEP_NAME_SIMPLIFICATION, NumberlineConstants.TIME_SUB_DELAY_AFTER_SIMPLIFICATION, CgsFVConstants.STEP_TYPE_SIMPLIFICATION);
//				simplificationStep.addCallback(0, prepForSimplification, null, prepForSimplification_reverse);
//				simplificationStep.addTween(.1, new GTween(result, NumberlineConstants.TIME_SUB_DURATION_SIMPLIFICATION, { alpha:0 }, { ease:Sine.easeInOut } ));
//				simplificationStep.addTween(.1, new GTween(simplifiedResult, NumberlineConstants.TIME_SUB_DURATION_SIMPLIFICATION, { alpha:1 }, { ease:Sine.easeInOut } ));
//				simplificationStep.addCallback(.1 + NumberlineConstants.TIME_SUB_DURATION_SIMPLIFICATION, finalizeSimplification, null, finalizeSimplification_reverse);
//				m_animHelper.appendStep(simplificationStep);
//			}*/
//
//        // Final Position
//        var unposition_unitDelay : Float = m_animHelper.computeScaledTime(NumberlineConstants.TIME_SUB_DELAY_AFTER_UNPOSITION);
//        var unposition_unitDuration : Float = m_animHelper.computeScaledTime(NumberlineConstants.TIME_SUB_DURATION_UNPOSITION);
