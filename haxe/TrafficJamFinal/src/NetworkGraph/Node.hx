...
class Node
{
    ...
    public var associated_pipes : Array<Pipe>;
    ...
    public function new(_x : Float, _y : Float, _t : Float, _kind : String, _metadata : Dynamic = null)
    {
        ...
        associated_pipes = new Array<Pipe>();
    ...
    /**
		 ...
		 */
    public function addOutgoingEdge(_outgoing_port : String, _destination_node : Node, _destination_port : String, _edge_spline_control_points : Array<Point>, _linked_edge_set : EdgeSetRef, _metadata : Dynamic = null) : Void
    {
    ...
    /**
		 ...
		 */
    public function insertCircularTroublePoint(dx : Float = 0.0, dy : Float = 0.0, radius : Float = 110) : Void
    {
        if (node_board == null)
        {
    ...
    /**
		 ...
		 */
    public function insertRectangularTroublePoint(dx : Float = 0.0, dy : Float = 0.0, w : Float = 200.0, h : Float = 100.0) : Void
    {
        if (node_board == null)
        {
