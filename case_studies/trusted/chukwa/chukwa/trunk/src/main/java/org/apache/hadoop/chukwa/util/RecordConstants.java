...
public class RecordConstants {
  ...
  @SuppressWarnings("regex") // char as regex
  public static final /*@Regex*/ String RECORD_SEPARATOR_ESCAPE_SEQ = new String(CTRL_D);// may
                                                                              // want
                                                                              // this
                                                                              // to
                                                                              // be
   ...
   */
  public static String escapeAllButLastRecordSeparator(/*@Regex*/ String recordSeparator,
      String record) {
   ...
   */
  public static String escapeAllRecordSeparators(/*@Regex*/ String recordSeparator,
      String record) {
    return record.replaceAll(recordSeparator, RECORD_SEPARATOR_ESCAPE_SEQ
        + recordSeparator);
  }

  public static String recoverRecordSeparators(/*@Regex*/ String recordSeparator,
      String record) {
