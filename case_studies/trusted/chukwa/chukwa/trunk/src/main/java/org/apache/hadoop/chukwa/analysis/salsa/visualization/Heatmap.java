...
public class Heatmap {
  ...
  protected @Trusted String query_state;
  protected String query_stat_type;
  protected final @Trusted String table = new @Trusted String("filesystem_fsm");
  ...
  public Heatmap() {
    ...
    this.query_state = new @Trusted String("");
   ...
   */
  public Heatmap
    (String timezone, String cluster, @Trusted String event_type, 
     ...
     HashMap<String, String> valmap) 
  {
    ...
    this.query_state = new @Trusted String(event_type);
  ...
  public Heatmap
    (String timezone, String cluster, @Trusted String query_state, 
     String query_stat_type,
     HashMap<String, String> valmap, String shuffles) 
  {
    ...
    this.query_state = new @Trusted String(query_state);
    this.query_stat_type = new String(query_stat_type);
  ...
  public Heatmap(HttpServletRequest request) {
    ...
    if (query_state != null) {
      ...
      this.query_state = new @Trusted String("read");
    }
