...
public class Swimlanes {
  ...
  protected final @Trusted String table = new @Trusted String("mapreduce_fsm");
  protected boolean plot_legend = true;
  @SuppressWarnings("trusted") // initially null
  protected @Trusted String jobname = null;
  ...
  public void setJobName(@Trusted String s) {
    this.jobname = new @Trusted String(s);
  }
