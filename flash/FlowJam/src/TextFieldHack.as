...
package
{
	 ...
	 *  </ul> 
	 */
	public class TextFieldHack extends TextFieldWrapper
	{
		...
		private function createRenderedContents():void
		{
			...
			var textWidth:Number  = xScale * sNativeTextField.textWidth;
			var textHeight:Number = yScale * sNativeTextField.textHeight;
			...
			bitmapData.draw(sNativeTextField, new Matrix(xScale, 0, 0, yScale, 0, int(yOffset)-2));
