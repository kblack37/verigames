...
/**
	 ...
	 * @author Rich
	 */
class StripSubtractAnimator implements IFractionAnimator
{
    ...
    {
        return CgsFVConstants.STRIP_STANDARD_SUBTRACT;
    }
...
//        var resultForegroundColor : Int = (Reflect.hasField(details, CgsFVConstants.RESULT_FRACTION_FOREGROUND_COLOR)) ? Reflect.field(details, Std.string(CgsFVConstants.RESULT_FRACTION_FOREGROUND_COLOR)) : first.foregroundColor;
//        var resultBackgroundColor : Int = (Reflect.hasField(details, CgsFVConstants.RESULT_FRACTION_BACKGROUND_COLOR)) ? Reflect.field(details, Std.string(CgsFVConstants.RESULT_FRACTION_BACKGROUND_COLOR)) : first.backgroundColor;
//        var resultBorderColor : Int = (Reflect.hasField(details, CgsFVConstants.RESULT_FRACTION_BORDER_COLOR)) ? Reflect.field(details, Std.string(CgsFVConstants.RESULT_FRACTION_BORDER_COLOR)) : first.borderColor;
//        var resultTickColor : Int = (Reflect.hasField(details, CgsFVConstants.RESULT_FRACTION_TICK_COLOR)) ? Reflect.field(details, Std.string(CgsFVConstants.RESULT_FRACTION_TICK_COLOR)) : first.tickColor;
//        result.foregroundColor = resultForegroundColor;
//        result.backgroundColor = resultBackgroundColor;
//        result.borderColor = resultBorderColor;
//        result.tickColor = resultTickColor;
...
//
//        // Peel data
//        var resultAsFirstSegmentHolder : Sprite = new Sprite();
//        var resultAsFirstSegment : Sprite = new Sprite();
//        m_animController.addChild(resultAsFirstSegmentHolder);
//        m_animHelper.trackDisplay(resultAsFirstSegmentHolder);
//        resultAsFirstSegmentHolder.addChild(resultAsFirstSegment);
//        m_animHelper.trackDisplay(resultAsFirstSegment);
//
...
//        var secondSegmentDropPosition : Point = new Point(firstSegmentDropPosition.x + firstModule.valueOffsetX + (secondModule.baseWidth / 2) - secondModule.valueWidth, firstSegmentDropPosition.y);
//
//        // Merge data
...
//
//        // Tween into position
//        var position_unitDelay : Float = m_animHelper.computeScaledTime(StripConstants.TIME_SUB_DELAY_AFTER_POSITION);
//        var position_unitDuration : Float = m_animHelper.computeScaledTime(StripConstants.TIME_SUB_DURATION_POSITION);
...
//				**/
//
//            var changeDenom_unitDelay : Float = m_animHelper.computeScaledTime(StripConstants.TIME_SUB_DELAY_AFTER_CHANGE_DENOM);
//            var changeDenom_unitDuration : Float = m_animHelper.computeScaledTime(StripConstants.TIME_SUB_DURATION_CHANGE_DENOM);
//            var changeDenom_durationPerTick : Float = m_animHelper.computeScaledTime(StripConstants.TIME_SUB_DURATION_CHANGE_DENOM_PER_TICK);
//            var changeDenom_maxDuration_firstSegment : Float = m_animHelper.computeScaledTime(StripConstants.TIME_SUB_DURATION_CHANGE_DENOM_FIRST_SEGMENT_MAX);
//            var changeDenom_minDurationPerTick : Float = m_animHelper.computeScaledTime(StripConstants.TIME_SUB_DURATION_CHANGE_DENOM_PER_TICK_MIN);
...
//            changeFirstDenomStep.addTween(firstDenom_pulseMultiplier_startTime, new GTween(secondDenom_eqData.firstValueNR, changeDenom_unitDuration / 4, {
//                        denominatorScale : 1.5
//                    }, {
//                        ease : Sine.easeInOut
//                    }));
//            changeFirstDenomStep.addTween(firstDenom_pulseMultiplier_startTime + changeDenom_unitDuration / 4, new GTween(secondDenom_eqData.firstValueNR, changeDenom_unitDuration / 4, {
//                        denominatorScale : 1
//                    }, {
//                        ease : Sine.easeInOut
//                    }));
...
//                changeFirstDenomStep.addTweenSet(currTickStartTime, FVEmphasis.computePulseTweens(firstDenomData.multiplierHolder, firstTicksFadeDuration, 1, 1, StripConstants.PULSE_SCALE_GENERAL));
...
//                changeFirstDenomStep.addTweenSet(currTickStartTime, FVEmphasis.computePulseTweens(firstDenomData.multiplierHolder, otherTicksFadeDuration, 1, 1, StripConstants.PULSE_SCALE_GENERAL));
//                currTickStartTime += otherTicksFadeDuration;
//            }
//
...
//
//            // Pulse and move roaming multiplier
//            changeSecondDenomStep.addTween(secondDenom_pulseMultiplier_startTime, new GTween(firstDenom_eqData.firstValueNR, changeDenom_unitDuration / 4, {
//                        denominatorScale : 1.5
//                    }, {
//                        ease : Sine.easeInOut
//                    }));
//            changeSecondDenomStep.addTween(secondDenom_pulseMultiplier_startTime + changeDenom_unitDuration / 4, new GTween(firstDenom_eqData.firstValueNR, changeDenom_unitDuration / 4, {
//                        denominatorScale : 1
//                    }, {
//                        ease : Sine.easeInOut
//                    }));
...
//                changeSecondDenomStep.addTween(currTickStartTime, new GTween(tickAtIndex, firstTicksFadeDuration / 2, {
//                            alpha : 1
//                        }, {
//                            ease : Sine.easeInOut
//                        }));
//                changeSecondDenomStep.addTweenSet(currTickStartTime, FVEmphasis.computePulseTweens(tickAtIndex, firstTicksFadeDuration, 1, 1, StripConstants.PULSE_SCALE_SEGMENT));
//                changeSecondDenomStep.addTweenSet(currTickStartTime, FVEmphasis.computePulseTweens(secondDenomData.multiplierHolder, firstTicksFadeDuration, 1, 1, StripConstants.PULSE_SCALE_GENERAL));
//                currTickStartTime += firstTicksFadeDuration;
//            }
//
//            // Handle changing ticks of all the other segment rectangles
...
//                            ease : Sine.easeInOut
//                        }));
//                changeSecondDenomStep.addTweenSet(currTickStartTime, FVEmphasis.computePulseTweens(tickAtIndex, otherTicksFadeDuration, 1, 1, StripConstants.PULSE_SCALE_SEGMENT));
//                changeSecondDenomStep.addTweenSet(currTickStartTime, FVEmphasis.computePulseTweens(secondDenomData.multiplierHolder, otherTicksFadeDuration, 1, 1, StripConstants.PULSE_SCALE_SEGMENT));
//                currTickStartTime += otherTicksFadeDuration;
//            }
//
...
//
//        // Tween drop
//        var drop_unitDelay : Float = m_animHelper.computeScaledTime(StripConstants.TIME_SUB_DELAY_AFTER_DROP);
//        var emphasis_unitDuration : Float = m_animHelper.computeScaledTime(StripConstants.TIME_SUB_DURATION_EMPHASIS);
//        var drop_unitDuration : Float = m_animHelper.computeScaledTime(StripConstants.TIME_SUB_DURATION_DROP);
...
//        var shrinkStartTime : Float = dropSecond_startTime + drop_unitDuration;
//        var dropFirstValue_startTime : Float = shrinkStartTime + emphasis_unitDuration;
...
//                    ease : Sine.easeInOut
//                }));
//        dropStep.addCallback(shrinkStartTime, doShrink, null, doShrink_reverse);
//        dropStep.addTweenSet(shrinkStartTime, FVEmphasis.computeNullifyTweens(secondSegment, emphasis_unitDuration, 1, 1, StripConstants.PULSE_SCALE_SEGMENT));
...
//
//        // Tween Merge
//        var merge_unitDelay : Float = m_animHelper.computeScaledTime(StripConstants.TIME_SUB_DELAY_AFTER_MERGE);
//        var merge_unitDuration : Float = m_animHelper.computeScaledTime(StripConstants.TIME_SUB_DURATION_MERGE);
...
//                    ease : Sine.easeInOut
//                }));
//        mergeStep.addTween(fadeInResultValueStart, new GTween(resultAsFirstSegmentHolder, merge_unitDuration, {
//                    alpha : 0
//                }, {
//                    ease : Sine.easeInOut
//                }));
...
//                    ease : Sine.easeInOut
//                }));
//        mergeStep.addTweenSet(showResultStart, EquationData.animationEquationInline_phaseTwo(eqData, merge_unitDuration * (3 / 4)));
...
//        if (doSimplify)
//        {
//            var simplification_unitDelay : Float = m_animHelper.computeScaledTime(StripConstants.TIME_SUB_DELAY_AFTER_SIMPLIFICATION);
//            var simplification_unitDuration : Float = m_animHelper.computeScaledTime(StripConstants.TIME_SUB_DURATION_SIMPLIFICATION);
...
//
//        // Final Position
//        var unposition_unitDelay : Float = m_animHelper.computeScaledTime(StripConstants.TIME_SUB_DELAY_AFTER_UNPOSITION);
//        var unposition_unitDuration : Float = m_animHelper.computeScaledTime(StripConstants.TIME_SUB_DURATION_UNPOSITION);
...
//
//        // Go
//        m_animHelper.animate(subtractComplete, positionStep, unpositionStep);
//
//
//        /**
...
//
//            // Peel result as first
//            result.foregroundColor = first.foregroundColor;
//            result.backgroundColor = first.backgroundColor;
//            result.borderColor = first.borderColor;
//            result.tickColor = first.tickColor;
//            resultModule.peelValue(resultAsFirstSegment);
//            result.foregroundColor = resultForegroundColor;
//            result.backgroundColor = resultBackgroundColor;
//            result.borderColor = resultBorderColor;
//            result.tickColor = resultTickColor;
//            resultAsFirstSegmentHolder.x = result.x;
//            resultAsFirstSegmentHolder.y = result.y;
//            resultAsFirstSegment.x = -resultModule.totalWidth / 2 - StripConstants.TICK_THICKNESS / 2 + resultAsFirstSegment.width / 2;
//            resultAsFirstSegmentHolder.visible = false;
//
//            // Show result
//            result.visible = true;
//            result.alpha = 0;
...
//        {
//            firstSegmentHolder.visible = false;
//            resultAsFirstSegmentHolder.visible = true;
//        }  // Throw away peeled value, update first view with new fraction  ;
//
//
//
//        function doShrink_reverse() : Void
//        {
//            firstSegmentHolder.visible = true;
//            resultAsFirstSegmentHolder.visible = false;
//        }  // Throw away peeled value, update first view with new fraction  ;
...
//
//
//        var subtractComplete : Void->Void = function() : Void
//        {
