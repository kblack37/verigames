...
/**
	 ...
	 * @author Rich
	 */
class StripCompareSizeAnimator implements IFractionAnimator
{
    ...
    {
        return CgsFVConstants.STRIP_STANDARD_COMPARE_SIZE;
    }
...
//        var compareModule : StripFractionModule = (try cast(compareView.module, StripFractionModule) catch(e:Dynamic) null);
...
//        var offsetY : Float = compareModule.unitHeight / 2 + StripConstants.TICK_EXTENSION_DISTANCE * 2 + StripConstants.ANIMATION_MARGIN_VERTICAL_SMALL * 2;
...
//        compareSymbol.y = newFirstPosition.y - firstModule.unitHeight / 2 - StripConstants.ANIMATION_MARGIN_TEXT - compareSymbol.height / 2;
...
//        resultSymbolHolder.y = newFirstPosition.y - firstModule.unitHeight / 2 - StripConstants.ANIMATION_MARGIN_TEXT;
...
//
//        // Tween into position
//        var position_unitDelay : Float = m_animHelper.computeScaledTime(StripConstants.TIME_COMPARE_SIZE_DELAY_AFTER_POSITION);
//        var position_unitDuration : Float = m_animHelper.computeScaledTime(StripConstants.TIME_COMPARE_SIZE_DURATION_POSITION);
...
//
//        // Compare
//        var compare_unitDelay : Float = m_animHelper.computeScaledTime(StripConstants.TIME_COMPARE_SIZE_DELAY_AFTER_COMPARE);
//        var compare_unitDuration : Float = m_animHelper.computeScaledTime(StripConstants.TIME_COMPARE_SIZE_DURATION_COMPARE);
...
//                }));
//        compareStep.addTweenSet(compare_showFirst_startTime, FVEmphasis.computePulseTweens(firstSegment, compare_unitDuration, 1, 1, StripConstants.PULSE_SCALE_SEGMENT));
...
//                    alpha : StripConstants.FILL_ALPHA_COLORED
//                }));
//        compareStep.addTweenSet(compare_showSecond_startTime, FVEmphasis.computePulseTweens(secondSegment, compare_unitDuration, 1, 1, StripConstants.PULSE_SCALE_SEGMENT));
...
//        var showResult_unitDelay : Float = m_animHelper.computeScaledTime(StripConstants.TIME_COMPARE_SIZE_DELAY_AFTER_SHOW_RESULT);
//        var showResult_unitDuration : Float = m_animHelper.computeScaledTime(StripConstants.TIME_COMPARE_SIZE_DURATION_SHOW_RESULT);
...
//        }
//        showResultStep.addTweenSet(showResult_firstPulse_startTime, FVEmphasis.computePulseTweens(firstResultFrac, showResult_unitDuration, 1, 1, StripConstants.PULSE_SCALE_GENERAL_LARGE));
...
//                }));
//        showResultStep.addTweenSet(showResult_changeToResult_startTime, FVEmphasis.computePulseTweens(resultSymbolHolder, showResult_unitDuration, resultEndScale, resultEndScale, StripConstants.PULSE_SCALE_GENERAL_LARGE));
...
//                    alpha : 0
//                }));
//        showResultStep.addTweenSet(showResult_secondPulse_startTime, FVEmphasis.computePulseTweens(secondResultFrac, showResult_unitDuration, 1, 1, StripConstants.PULSE_SCALE_GENERAL_LARGE));
...
//
//        // Fade out
//        var fadeOut_unitDelay : Float = m_animHelper.computeScaledTime(StripConstants.TIME_COMPARE_SIZE_DELAY_AFTER_FADE);
//        var fadeOut_unitDuration : Float = m_animHelper.computeScaledTime(StripConstants.TIME_COMPARE_SIZE_DURATION_FADE);
...
//
//        // Final Position
//        var unposition_unitDelay : Float = m_animHelper.computeScaledTime(StripConstants.TIME_COMPARE_SIZE_DELAY_AFTER_UNPOSITION);
//        var unposition_unitDuration : Float = m_animHelper.computeScaledTime(StripConstants.TIME_COMPARE_SIZE_DURATION_UNPOSITION);
...
//        {
//            // Peel first
//            firstModule.paintColoredFill(firstSegment, 1);
...
//
//            // Peel second
//            secondModule.paintColoredFill(secondSegment, 1);
