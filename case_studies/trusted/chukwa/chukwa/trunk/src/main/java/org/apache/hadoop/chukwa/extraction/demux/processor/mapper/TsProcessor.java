...
public class TsProcessor extends AbstractProcessor {
  ...
  private Map<String, /*@Regex(1)*/ Pattern> datePatternMap;
  private Map<String, SimpleDateFormat> dateFormatMap;

  public TsProcessor() {
    datePatternMap = new HashMap<String, /*@Regex(1)*/ Pattern>();
   ...
   * @return
   */
  private /*@Regex(1)*/ Pattern fetchDateLocationPattern(String dataType) {
