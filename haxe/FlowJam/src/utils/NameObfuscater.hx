...
class NameObfuscater
{
    ...
    private static var color_names : Array<String> = [
    ...
    private static var color_values : Array<Int> = [
    ...
    private static var nature_nouns : Array<String> = [
    ...
    private static var place_suffixes : Array<String> = [
        "boro", "City", "Corner", "Depot", "ford", "ham", "Hamlet", "Junction", "mount", "Park", "Port", "Station", "ton", "Town", "Village", "ville"
    ];
    
    private var rand : PMPRNG;
    
    private var level_prefix_array : Array<String>;
    private var level_suffix_array : Array<String>;
    private var board_prefix_array : Array<String>;
    private var board_suffix_array : Array<String>;
    ...
    private var level_prefix_available_suffix_indices : Dynamic;
    
    /** A list of all prefix indices with at least one available suffix pair */
    private var available_board_prefix_indices : Array<Int>;
    
    /** A Dictionary of Vector.<uint> representing unused suffixes for the given prefix key */
    private var board_prefix_available_suffix_indices : Dynamic;
    
    /** Dictionaries from original_names -> obfuscated_names */
    public var obfuscatedLevelNameDictionary : Dynamic = {};
    public var obfuscatedBoardNameDictionary : Dynamic = {};
    
    public var reverseObfuscatedLevelNameDictionary : Dynamic = {};
    public var reverseObfuscatedBoardNameDictionary : Dynamic = {};
    
    /** Dictionary from original_names -> colors (valid if using color_names) */
    public var namesToColorsDictionary : Dynamic = {};
    ...
    private function setupLevelNames() : Void
    {
        ...
        level_prefix_available_suffix_indices = {};
        var prefix_i : Int = 0;
        for (my_level_prefix in level_prefix_array)
        {
			...
			Reflect.setField(level_prefix_available_suffix_indices, my_level_prefix, my_avail_indx);
            prefix_i++;
        }
    }
    ...
    private function setupBoardNames() : Void
    {
        ...
        board_prefix_available_suffix_indices = {};
        var prefix_i : Int = 0;
        for (my_board_prefix in board_prefix_array)
        {
            ...
            Reflect.setField(board_prefix_available_suffix_indices, my_board_prefix, my_avail_indx);
            prefix_i++;
        }
    }
    ...
    {
        return Reflect.hasField(obfuscatedBoardNameDictionary, _original_board_name);
    }
    
    public function getBoardName(_original_board_name : String, _original_level_name : String) : String
    {
        if (Reflect.hasField(obfuscatedBoardNameDictionary, _original_board_name))
        {
    ...
    {
        if (reverseObfuscatedBoardNameDictionary.exists(obfuscatedName))
        {
    ...
    {
        if (available_level_prefix_indices == null)
        {
        ...
        var available_suffix_indx : Array<Int> = Reflect.field(level_prefix_available_suffix_indices, level_prefix);
    ...
    private function getNextBoardName() : String
    {
        ...
        var available_suffix_indx : Array<Int> = Reflect.field(board_prefix_available_suffix_indices, board_prefix);
        if ((available_suffix_indx != null) && (available_suffix_indx.length > 0))
        {
