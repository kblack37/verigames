package VisualWorld
{
	...
	public class Ball extends DropObjectBase
	{
		 ...
		 */
		public function Ball(_starting_edge:Edge, _ghost:Boolean = false)
		{
		 ...
		 * 
		 */
		override public function updateImageAndFlow(stopObject:Boolean = false):void {
			...
			switch(m_flowObject.starting_ball_type) {
		...
		public static function drawBall(_wide:Boolean, _drop_object:DropObjectBase, _alpha:Number = 1.0, _highlight:Boolean = false):void {
			var ball_color:Number;
			var ball_border_width:uint = 2;
			
			var refl_offset:Array;// shift the "reflection spot" to the bottom right or top left
			var grad_width:Number;
			var inv_color:Number;
			var radius:Number;
			var colors:Array;
			var alphas:Array;
			var ratios:Array;
			...
			colors = new Array(inv_color, ball_color);
			alphas = new Array(_alpha, _alpha);
			ratios = new Array(0, 128);
			matrix = new Matrix();
