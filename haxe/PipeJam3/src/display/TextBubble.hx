...
class TextBubble extends Sprite
{
    ...
    public function new(_text : String, _fontSize : Float = 10, _fontColor : Int = 0xEEEEEE,
            ...
            _showBox : Bool = true, _arrowColor : Float = Math.NaN, _outlineWeight : Float = 0,
            _outlineColor : Int = 0x0)
    {
        ...
        if (m_pointAt != null)
        {
            ...
            m_tutorialArrow.color = (Math.isNaN(_arrowColor)) ? (((PipeJam3.ASSET_SUFFIX == "Turk")) ? Constants.NARROW_GRAY : Constants.BROWN) : _arrowColor;
    ...
    private function onEnterFrame(evt : Event) : Void
    {
        ...
        {
            var newX : Float = (Constants.GameWidth - Constants.RightPanelWidth) / 2;
