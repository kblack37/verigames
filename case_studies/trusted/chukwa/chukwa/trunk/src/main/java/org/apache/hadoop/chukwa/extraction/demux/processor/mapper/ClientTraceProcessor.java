...
public class ClientTraceProcessor extends AbstractProcessor {
  ...
  private final /*@Regex(2)*/ Matcher kvMatcher;
  private final /*@Regex(1)*/ Matcher idMatcher;
  private final Matcher ipMatcher;
  // extract date, source
  private final /*@Regex(1)*/ Pattern idPattern =
    Pattern.compile("^(.{23}).*clienttrace.*");
  // extract "key: value" pairs
  private final /*@Regex(2)*/ Pattern kvPattern =
