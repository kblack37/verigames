package dialogs
{
	...
	public class RankProgressDialog extends TutorialText
	{
		protected var dialogInfo:RankProgressDialogInfo;
		
		public function RankProgressDialog(level:Level, info:RankProgressDialogInfo, numLevelsSolved:int)
		{
			super(level, info);
			dialogInfo = info;
