...
This is version 4.1 of Mochi Ads, Mochi Achievements and Mochi Scores API.
...
New in 4.1.1:
- Fix dependency on flex to build a game using API.

New in 4.1.0:
- Added generic support for universal data store. Removed the need for authentication to use
  USD. See documentaion for more details.
- Group Ads (CPA) fixes that included better scaling and drawing of ads.
