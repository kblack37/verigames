...
public class Top extends AbstractProcessor {
  ...
  private static /*@Regex(3)*/ String regex = "([0-9]{4}-[0-9]{2}-[0-9]{2} [0-9]{2}:[0-9]{2}:[0-9]{2},[0-9]{3}) (.*?) (.*?): ";
  private static /*@Regex(3)*/ Pattern p = null;

  private /*@Regex(3)*/ Matcher matcher = null;
