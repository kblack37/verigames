...
class ReplayTimeline extends Sprite
{
    ...
    public function new(actionObjects : Array<Dynamic>, skipCallback : Function, toIndexCallback : Function, desiredWidth : Float, y_pos : Float)
    {
        super();
        desiredWidth -= 100;
        x = 10;
        ...
        {
            var obj : Dynamic = actionObjects[ii];
            var thisStep : Int = ii;
